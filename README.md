...
Cloud sessions install the plugin automatically at session start. Locally, accept the install prompt on first launch (or run `claude plugin install ai-dev-team@claude-teams`).
