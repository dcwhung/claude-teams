---
description: QA 執行測試計劃，輸出 QA 報告
argument-hint: [scope | CUI-XXXX]
---
...
- Ticket 建立流程（CUI-XXXX）→ `skills/sw-ticket-management/SKILL.md`
- QA 完成後 handoff（release / reject）→ `skills/sw-post-review-handoff/SKILL.md` → Protocol 2
