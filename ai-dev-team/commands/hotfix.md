---
description: 緊急修復，checkout 自 main，Developer + DevOps
...
- Branch 命名、Pre-Flight Checklist（source=main）、Commit 格式 → `skills/sw-git-flow/SKILL.md`
- Review 門檻 75 分 → `agents/code-reviewer.md`
- Hotfix handoff chain（Reviewer → DevOps → QA smoke test + back-merge）
  → `skills/sw-post-review-handoff/SKILL.md` → Protocol 3
...
> （見 `skills/sw-post-review-handoff/SKILL.md` → Protocol 3 Step 3）。
