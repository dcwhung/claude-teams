...
所有 agent 必須遵守 `skills/sw-post-review-handoff/SKILL.md` 定義嘅 handoff protocol。
...
詳見 `skills/sw-post-review-handoff/SKILL.md`。
...
- Git flow 細節 → 用到先 Read `skills/sw-git-flow/SKILL.md`
- TDD 循環 → 用到先 Read `skills/sw-tdd/SKILL.md`
- CI/CD pipeline 細節 → 用到先 Read `skills/sw-ci-cd/SKILL.md`
- Coding style 規則 → 用到先 Read `skills/sw-coding-style/SKILL.md`（入口），再按語言 Read `skills/sw-coding-style-ts/SKILL.md` / `php.md` / `py.md`
- Handoff protocol → 任務完成前 Read `skills/sw-post-review-handoff/SKILL.md`
