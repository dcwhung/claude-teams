...
> 對 multi-fix / multi-feature 嘅**決策層**（要唔要 parallel、conflict matrix、lane clustering、batch review/QA/release）→ 見 `skills/sw-parallel-dispatch/SKILL.md`（Single Source of Truth）。
...
`skills/sw-hooks/SKILL.md` + Autonomous Loop 組合：
