...
> **唔涵蓋** merge / branch delete / release tag / rollback 呢類 routing side effects；呢啲一律由 **main agent** 按 `skills/sw-post-review-handoff/SKILL.md` 執行。
...
> **所有 handoff 規則定義於 `skills/sw-post-review-handoff/SKILL.md`（Single Source of Truth）。**
