...
cp ${CLAUDE_PLUGIN_ROOT}/templates/project-claude.md \
...
# 5. 建立標準 .gitignore（見 skills/sw-git-flow/SKILL.md → "Project Git 初始化"）
git init
cat > .gitignore << 'EOF'
# OS
.DS_Store
...
Project `CLAUDE.md` 模板位置：`${CLAUDE_PLUGIN_ROOT}/templates/project-claude.md`
