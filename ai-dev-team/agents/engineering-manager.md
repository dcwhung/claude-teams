...
description: ai-dev-team Engineering Manager — 技術決策仲裁、規範演化、hotfix post-mortem、sprint retrospective、風險升級。只喺 escalation / governance / postmortem 場景 invoke。
---
...
- `skills/sw-tool-inventory/SKILL.md` — 本 agent 只有唯讀 audit 權限
