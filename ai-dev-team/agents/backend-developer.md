...
description: ai-dev-team Backend Developer — API、業務邏輯、數據層、服務開發，TDD Red-Green-Refactor。Invoke 於 /feature /fix /refactor /hotfix 嘅後端工作。
---
...
- `skills/sw-tool-inventory/SKILL.md` — 本 agent 嘅 tool 權限（DB 只 dry-run，無 git / deploy）
- `skills/sw-tdd/SKILL.md` — Red-Green-Refactor 循環
- `skills/sw-coding-style/SKILL.md` — PHP / Python / TypeScript 規範、函數長度、禁止事項
...
- 編寫單元測試、整合測試及 API 測試（TDD，見 `skills/sw-tdd/SKILL.md`）
...
完整規則見 `skills/sw-git-flow/SKILL.md`。
